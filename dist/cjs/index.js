...
var StackGrid = React.forwardRef(function (_a, ref) {
    ...
    var _d = React.useState(0), containerHeight = _d[0], setContainerHeight = _d[1];
    var getContainerWidth = React.useCallback(function () {
        var _a;
        return ((_a = containerRef.current) === null || _a === void 0 ? void 0 : _a.clientWidth) || 0;
    }, []);
    var calculateColumnCount = React.useCallback(function (containerWidth, colMinWidth, gutter) {
        return Math.max(Math.floor((containerWidth + gutter) / (colMinWidth + gutter)), 1);
    }, []);
    var calculateColumnWidth = React.useCallback(function (containerWidth, columnCount, gutter) {
        return (containerWidth - gutter * (columnCount - 1)) / columnCount;
    }, []);
    var generateBaseColumns = React.useCallback(function (columnCount, columnWidth, gutter) {
        return Array.from({ length: columnCount }, function (_, i) { return ({
            x: i * (columnWidth + gutter),
            h: 0
        }); });
    }, []);
    var updateColumnData = React.useCallback(function () {
    ...
    var arrangeItems = React.useCallback(function (children, cols, columnWidth) {
